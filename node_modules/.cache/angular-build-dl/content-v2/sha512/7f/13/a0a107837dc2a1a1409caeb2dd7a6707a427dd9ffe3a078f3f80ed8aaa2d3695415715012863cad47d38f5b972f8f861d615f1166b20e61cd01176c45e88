...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function srcAppApiserviceServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ApiserviceService = /*#__PURE__*/function () {
      ...
      _createClass(ApiserviceService, [{
        key: "getDiagram",
        value: function getDiagram(configdata) {
          return this.httpClient.post("".concat(this.apiURL, "petri_diagram/petri_to_json"), configdata, {
            headers: {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var petri_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! petri-js */
    "./node_modules/petri-js/dist/index.js");
    /* harmony import */


    var petri_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(petri_js__WEBPACK_IMPORTED_MODULE_2__);
    /* harmony import */


    var diagram_library__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! diagram-library */
    "./node_modules/diagram-library/MindFusion.Diagramming.js");
    /* harmony import */


    var diagram_library__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(diagram_library__WEBPACK_IMPORTED_MODULE_3__);
    /* harmony import */


    var _apiservice_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./apiservice.service */
    "./src/app/apiservice.service.ts");
    ...
    var AppComponent = /*#__PURE__*/function () {
      ...
      _createClass(AppComponent, [{
        ...
        key: "nodeCreated",
        value: function nodeCreated($event) {
          console.log("node Created"); //console.log($event.args.link)
          ...
          for (var each in this.state_node) {
            if (this.state_node[each].name === origin) {
              var result = this.data.filter(function (x) {
        ...
        key: "textEdited",
        value: function textEdited($event) {
          console.log('text-edited');
        }
      }, {
        key: "onNodeDoubleClicked",
        value: function onNodeDoubleClicked($event) {
        ...
        key: "showPetriDiagram",
        value: function showPetriDiagram(data) {
          console.log(data);
          this.view_demo = true;
          var model = data;
          var petrinet = new petri_js__WEBPACK_IMPORTED_MODULE_2___default.a(document.getElementById('inner_canvas'), model);
        }
      }, {
        key: "importPetri",
        value: function importPetri($event) {
          var _this = this;
          ...
          if (file) {
            ...
            reader.onload = function (eve) {
              ...
              _this.showPetriDiagram(json_data);

              console.log(json_data);
            };

            reader.onerror = function (eve) {
              _this.showMessage('Failed to load preview 😞 ');
            };

            reader.onabort = function (eve) {
              _this.showMessage('Failed to load preview 😞 ');
            };
          }
        }
        ...
        value: function setPreview() {
          ...
          this.ApiService.getDiagram(payloads).subscribe(function (data) {
            new petri_js__WEBPACK_IMPORTED_MODULE_2___default.a(document.getElementById('preview'), data['dd']);
          }, function (error) {
            _this2.msg = 'Failed to load preview 😞 ';
          });
        }
      }]);
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var diagram_library_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! diagram-library-angular */
    "./node_modules/diagram-library-angular/fesm2015/diagram-library-angular.js");
    /* harmony import */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], diagram_library_angular__WEBPACK_IMPORTED_MODULE_5__["AngularDiagram"], _angular_material_expansion__WEBPACK_IMPORTED_MODULE_7__["MatExpansionModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_10__["BrowserAnimationsModule"], _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatButtonModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_8__["MatInputModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_9__["MatCardModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpClientModule"], _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatToolbarModule"]],
      providers: [],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/akhil/Desktop/Work/petri_viewer/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
